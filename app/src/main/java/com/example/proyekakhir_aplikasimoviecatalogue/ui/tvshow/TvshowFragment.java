...
import com.example.proyekakhir_aplikasimoviecatalogue.ui.search.SearchTvshowActivity;
...
public class TvshowFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvshowViewModel.getTvshow().observe(getViewLifecycleOwner(), new Observer<ArrayList<Data>>() {
            @Override
